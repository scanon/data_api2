...
public class FeatureData {
    ...
    private List<String> featureNotes;
    ...
    @JsonProperty("feature_notes")
    public List<String> getFeatureNotes() {
        return featureNotes;
    }

    @JsonProperty("feature_notes")
    public void setFeatureNotes(List<String> featureNotes) {
        this.featureNotes = featureNotes;
    }

    public FeatureData withFeatureNotes(List<String> featureNotes) {
        this.featureNotes = featureNotes;
        return this;
    }
